  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        header: "New",
        cell: info => (
          <span className="font-semibold text-green-600 text-sm">{info.getValue() || 0}</span>
        ),
      },
      {
        ...
        header: "Update",
        cell: info => (
          <span className="font-semibold text-yellow-600 text-sm">{info.getValue() || 0}</span>
        ),
      },
      {
        ...
        header: "Failed",
        cell: info => (
          <span className="font-semibold text-red-600 text-sm">{info.getValue()}</span>
        ),
      },
    ],
    []
    ...
    <div className="px-4 py-6 max-w-7xl mx-auto">
      <div className="flex justify-end mb-6">
        <button
          onClick={() => getData()}
          disabled={isFetching}
          className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white px-5 py-2 rounded-lg shadow-lg hover:brightness-110 transition disabled:opacity-60 disabled:cursor-not-allowed font-semibold"
        >
